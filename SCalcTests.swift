...
class SCalcTests: XCTestCase {
    ...
    func testPlusOperation_01() {
        var str = ""
        // 1. given
        str = model.treatEvent(event:"2").num
        str = model.treatEvent(event:"+").num
        str = model.treatEvent(event:"2").num
        // 2. when
        str = model.treatEvent(event:"=").num
        // 3. then
    ...
    func testPlusOperation_02() {
        ...
        // 1. given
        str = model.treatEvent(event:"2").num
        str = model.treatEvent(event:"3").num
        str = model.treatEvent(event:"+").num
        str = model.treatEvent(event:"2").num
        // 2. when
        str = model.treatEvent(event:"=").num
    ...
    func testRejectInitialZeros() {
        var str = ""
        // 1. given
        str = model.treatEvent(event:"0").num
        str = model.treatEvent(event:"0").num
        str = model.treatEvent(event:"0").num
        str = model.treatEvent(event:"0").num
        // 2. when
    ...
    func testRejectDoublePoints() {
        ...
        str = model.treatEvent(event:".").num
        // 2. when
        str = model.treatEvent(event:"1").num
        // 3. then
    ...
    func testLimits() {
        var str = ""
        // 1. given
        //str = model.treatEvent(event:"9").num
        str = model.treatEvent(event:"9").num
        str = model.treatEvent(event:"9").num
        str = model.treatEvent(event:"9").num
        str = model.treatEvent(event:"9").num
        ...
        str = model.treatEvent(event:"=").num
        // 3. then
        XCTAssertEqual(str, "100000000000", "Doze digitos, nao aceita...")
    }
